...
export default function Trending() {
  ...
  const demoPitches: Pitch[] = [/* … keep your demo pitches here … */];

  useEffect(() => {
    fetchTrending();
  }, [fetchTrending]);

  // Update underline when filter changes
  useEffect(() => {
  ...
  return (
    <div className="relative">
      {/* grid background + mask here … */}

      <header className="mx-auto max-w-6xl px-4 pt-16 pb-6 text-center">
        <h1 className="text-4xl font-black text-gray-900 sm:text-5xl">Trending pitches</h1>
        <p className="mt-3 text-lg text-gray-600">
          The hottest ideas rising in the PeerPitch community.
        </p>

        {/* Filter buttons with adaptive underline */}
